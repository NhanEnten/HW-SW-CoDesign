...
module bd_0
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.IN1_ADDRESS1 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.IN1_ADDRESS1, LAYERED_METADATA undef" *) output [7:0]in1_address1;
  output in1_ce0;
  output in1_ce1;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.IN1_Q1 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.IN1_Q1, LAYERED_METADATA undef" *) input [31:0]in1_q1;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.IN2_ADDRESS1 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.IN2_ADDRESS1, LAYERED_METADATA undef" *) output [7:0]in2_address1;
  output in2_ce0;
  output in2_ce1;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.IN2_Q1 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.IN2_Q1, LAYERED_METADATA undef" *) input [31:0]in2_q1;
