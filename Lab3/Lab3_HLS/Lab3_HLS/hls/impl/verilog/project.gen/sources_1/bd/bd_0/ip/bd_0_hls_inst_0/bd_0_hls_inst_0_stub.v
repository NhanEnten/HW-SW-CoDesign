...
//               /home/nhanenten/Desktop/HW_SW/Lab3/Lab3_HLS/Lab3_HLS/hls/impl/verilog/project.gen/sources_1/bd/bd_0/ip/bd_0_hls_inst_0/bd_0_hls_inst_0_stub.v
...
(* CHECK_LICENSE_TYPE = "bd_0_hls_inst_0,matmul,{}" *) (* CORE_GENERATION_INFO = "bd_0_hls_inst_0,matmul,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=matmul,x_ipVersion=1.0,x_ipCoreRevision=2114624443,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "matmul,Vivado 2025.2" *) (* hls_module = "yes" *) 
module bd_0_hls_inst_0(in1_ce0, in1_ce1, in2_ce0, in2_ce1, out_r_ce0, 
  out_r_we0, ap_clk, ap_rst, ap_done, ap_idle, ap_ready, ap_start, in1_address0, in1_q0, 
  in1_address1, in1_q1, in2_address0, in2_q0, in2_address1, in2_q1, out_r_address0, out_r_d0, size)
/* synthesis syn_black_box black_box_pad_pin="in1_ce0,in1_ce1,in2_ce0,in2_ce1,out_r_ce0,out_r_we0,ap_rst,ap_done,ap_idle,ap_ready,ap_start,in1_address0[7:0],in1_q0[31:0],in1_address1[7:0],in1_q1[31:0],in2_address0[7:0],in2_q0[31:0],in2_address1[7:0],in2_q1[31:0],out_r_address0[7:0],out_r_d0[31:0],size[31:0]" */
