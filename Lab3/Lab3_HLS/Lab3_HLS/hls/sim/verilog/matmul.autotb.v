...
`define AUTOTB_TVIN_size  "../tv/cdatafile/c.matmul.autotvin_size.dat"
`define AUTOTB_TVIN_in1_out_wrapc  "../tv/rtldatafile/rtl.matmul.autotvin_in1.dat"
`define AUTOTB_TVIN_in2_out_wrapc  "../tv/rtldatafile/rtl.matmul.autotvin_in2.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "../tv/rtldatafile/rtl.matmul.autotvin_out_r.dat"
`define AUTOTB_TVIN_size_out_wrapc  "../tv/rtldatafile/rtl.matmul.autotvin_size.dat"
`define AUTOTB_TVOUT_out_r  "../tv/cdatafile/c.matmul.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "../tv/rtldatafile/rtl.matmul.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 2052;
parameter LENGTH_in1 = 256;
parameter LENGTH_in2 = 256;
...
wire [4 - 1 : 0]    arrayin1_we0, arrayin1_we1;
wire    [7 : 0]    arrayin1_address0, arrayin1_address1;
...
event in1_reshape_ap_done_evt;
event in1_reshape_ap_ready_evt;
initial begin
     `AESL_MEM_INST_in1.initialed       = svtb_top.misc_if.initialed_evt  ;
     `AESL_MEM_INST_in1.finished        = svtb_top.misc_if.finished_evt   ;
     `AESL_MEM_INST_in1.dut2tb_ap_ready = svtb_top.misc_if.dut2tb_ap_ready_evt;
     `AESL_MEM_INST_in1.dut2tb_ap_done = svtb_top.misc_if.dut2tb_ap_ready_evt;
end
//------------------------arrayin2 Instantiation--------------

// The input and output of arrayin2
wire    arrayin2_ce0, arrayin2_ce1;
wire [4 - 1 : 0]    arrayin2_we0, arrayin2_we1;
wire    [7 : 0]    arrayin2_address0, arrayin2_address1;
...
event in2_reshape_ap_done_evt;
event in2_reshape_ap_ready_evt;
initial begin
     `AESL_MEM_INST_in2.initialed       = svtb_top.misc_if.initialed_evt  ;
     `AESL_MEM_INST_in2.finished        = svtb_top.misc_if.finished_evt   ;
     `AESL_MEM_INST_in2.dut2tb_ap_ready = svtb_top.misc_if.dut2tb_ap_ready_evt;
     `AESL_MEM_INST_in2.dut2tb_ap_done = svtb_top.misc_if.dut2tb_ap_ready_evt;
end
