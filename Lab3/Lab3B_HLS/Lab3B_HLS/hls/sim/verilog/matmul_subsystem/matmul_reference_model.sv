...
`ifndef MATMUL_REFERENCE_MODEL_SV
`define MATMUL_REFERENCE_MODEL_SV

class matmul_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(matmul_reference_model)
