...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename in1 \
    op interface \
    ports { in1_address0 { O 8 vector } in1_ce0 { O 1 bit } in1_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename in2 \
    op interface \
    ports { in2_address0 { O 8 vector } in2_ce0 { O 1 bit } in2_q0 { I 32 vector } } \
} "
} else {
...
set InstName matmul_flow_control_loop_delay_pipe_U
set CompName matmul_flow_control_loop_delay_pipe
