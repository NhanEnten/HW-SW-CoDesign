...
dict set report_options hls_project Lab3B_HLS
...
dict set report_options topmodule "matmul"
dict set report_options funcmodules {}
dict set report_options bindmodules {matmul_mul_32s_32s_32_2_1 matmul_flow_control_loop_delay_pipe}
